...
def function_reward_list(list_,height_):
    if len(list_)==2:
            ...
            function_code= [f"        height_reward =  100*(self.state_vector()[{list_[0]}]/{height_}) if self.state_vector()[{list_[1]}]/{height_} > 1.0 else 0.0 \n",
    f"        height_reward_2 = 10*(self.state_vector()[{list_[1]}]/{height_}) if self.state_vector()[{list_[1]}]/{height_} > 0.5 and self.state_vector()[{list_[1]}]/{height_} < 1.0 else 0.0\n",
    f"        height_reward_3 = -10*abs((self.state_vector()[{list_[1]}]/{height_})) if self.state_vector()[{list_[1]}]/{height_} < 0.5 else 0.0\n",                 
    f"        x_reward = 100 * self.state_vector()[{list_[0]}] if self.state_vector()[{list_[0]}] > 1.0 else 0.0\n",                       
    f"        x_reward_2 = 10 * self.state_vector()[{list_[0]}] if self.state_vector()[{list_[0]}] > 0.5 and self.state_vector()[{list_[0]}] < 1.0 else 0.0\n",
    f"        x_reward_3 = -10 * self.state_vector()[{list_[0]}] if self.state_vector()[{list_[0]}] < 0.5 else 0.0\n",
    ...
    "        reward = forward_reward  + total_reward - ctrl_cost\n"]
            ...
            function_code= [f"        height_reward =  100*(self.state_vector()[{list_[1]}]/{height_}) if self.state_vector()[{list_[1]}]/{height_} > 1.0 else 0.0 \n",
    f"        height_reward_2 = 10*(self.state_vector()[{list_[1]}]/{height_}) if self.state_vector()[{list_[1]}]/{height_} > 0.5 and self.state_vector()[{list_[1]}]/{height_} < 1.0 else 0.0\n",
    f"        height_reward_3 = -10*abs((self.state_vector()[{list_[1]}]/{height_})) if self.state_vector()[{list_[1]}]/{height_} < 0.5 else 0.0\n",                       
    f"        x_reward = 100 * self.state_vector()[{list_[0]}] if self.state_vector()[{list_[0]}] > 3.0 else 0.0\n",                       
    f"        x_reward_2 = 10 * self.state_vector()[{list_[0]}] if self.state_vector()[{list_[0]}] > 0.5 and self.state_vector()[{list_[3]}] < 3.0 else 0.0\n",
    f"        x_reward_3 = -10 * abs(self.state_vector()[{list_[0]}]) if self.state_vector()[{list_[0]}] < 0.5 else 0.0\n",
    f"        x_velocity_reward = 10*self.state_vector()[{list_[2]}] if self.state_vector()[{list_[2]}] > 1.0 else  0.0\n",  
    f"        x_velocity_reward_2 = 5*self.state_vector()[{list_[2]}] if self.state_vector()[{list_[2]}] < 1.0 and self.state_vector()[{list_[2]}] > 0.5 else 0.0\n",
    f"        z_velocity_reward = 10*self.state_vector()[{list_[3]}] if self.state_vector()[{list_[3]}] > 1.0 else 0.0\n", 
    f"        z_velocity_reward_2 = 5*self.state_vector()[{list_[3]}] if self.state_vector()[{list_[3]}] < 1.0 and self.state_vector()[{list_[3]}] > 0.5 else 0.0\n",
